...
func (r *mockCustomerRepo) ListAdminUsers(_ context.Context, _, _ int) ([]customer.Customer, error) {
	return nil, nil
}

func (r *mockCustomerRepo) CountActiveByRole(_ context.Context, _ customer.Role) (int, error) {
	return 0, nil
}
