...
func newCouponAdminRouter(h *shophttp.CouponAdminHandler) *http.ServeMux {
...
func couponAdminWithSink(coupons *mockCouponRepo, promotions *mockPromotionRepo, sink *auditSink) *shophttp.CouponAdminHandler {
	return shophttp.NewCouponAdminHandlerWithAuditor(coupons, promotions, admin.NewAuditor(sink))
}
...
func TestCouponAdminHandler_List_OK(t *testing.T) {
	...
	h := shophttp.NewCouponAdminHandler(coupons, promotions)
...
func TestCouponAdminHandler_Create_OK(t *testing.T) {
	...
	last := sink.Last(t)
	if last.context["action"] != admin.AuditCouponCreate {
		t.Errorf("audit action = %v, want %v", last.context["action"], admin.AuditCouponCreate)
	}
...
func TestCouponAdminHandler_Delete_OK(t *testing.T) {
	...
	last := sink.Last(t)
	if last.context["action"] != admin.AuditCouponDelete {
		t.Errorf("audit action = %v, want %v", last.context["action"], admin.AuditCouponDelete)
	}
}
...
func TestCouponAdminHandler_Delete_NotFound(t *testing.T) {
	...
	h := shophttp.NewCouponAdminHandler(coupons, &mockPromotionRepo{})
...
func TestCouponAdminHandler_Create_ForbiddenWithoutWritePermission(t *testing.T) {
	h := shophttp.NewCouponAdminHandler(&mockCouponRepo{}, &mockPromotionRepo{})
