...
func newCategoryRouter(h *storefront.CategoryHandler) *http.ServeMux {
...
func newAdminCategoryRouter(h *storefront.CategoryHandler) *http.ServeMux {
...
func TestCategoryHandler_Tree_OK(t *testing.T) {
	...
	h := storefront.NewCategoryHandler(cats, prods)
...
func TestCategoryHandler_AdminTree_OK(t *testing.T) {
	...
	h := storefront.NewCategoryHandler(cats, &mockCatProductRepo{})
...
func TestCategoryHandler_AdminTree_Forbidden(t *testing.T) {
	h := storefront.NewCategoryHandler(&mockCategoryRepo{}, &mockCatProductRepo{})
	mux := newAdminCategoryRouter(h)
