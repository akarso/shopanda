...
func newSearchRouter(h *storefront.SearchHandler) *http.ServeMux {
...
func TestSearchHandler_OK(t *testing.T) {
	...
	h := storefront.NewSearchHandler(engine)
...
func TestSearchHandler_WithAttributeFilter(t *testing.T) {
	...
	h := storefront.NewSearchHandler(engine).WithAdvancedSearchAttributes(lister)
