...
func NewAuthHandler(svc *appAuth.Service, trustedProxies ...string) *AuthHandler {
	return &AuthHandler{
		svc:            svc,
		trustedProxies: httpshared.ParseTrustedProxies(trustedProxies),
	}
}
...
func (h *AuthHandler) Register() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusCreated, authTokenResponse{
...
func (h *AuthHandler) Login() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, authTokenResponse{
			CustomerID: out.CustomerID,
			Token:      out.Token,
			ExpiresAt:  out.ExpiresAt.Format("2006-01-02T15:04:05Z"),
		})
...
func (h *AuthHandler) Me() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, meResponse{
			ID:        c.ID,
			Email:     c.Email,
...
func (h *AuthHandler) ChangePassword() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]string{"message": "password changed"})
	}
}
...
func (h *AuthHandler) Logout() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]string{"message": "logged out"})
	}
}
...
func (h *AuthHandler) RequestPasswordReset() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]string{
...
func (h *AuthHandler) ConfirmPasswordReset() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]string{"message": "password has been reset"})
	}
}
