...
func newStorefrontRouter(h *storefront.StorefrontHandler) http.Handler {
	router := httpshared.NewRouter()
	router.Use(httpshared.CSRFMiddleware())
...
func TestStorefrontHandler_Product_OK(t *testing.T) {
	...
	h := storefront.NewStorefrontHandler(engine, repo, newStorefrontCategoryMock(), pdp, plp, newStorefrontSearchMock())
...
func TestStorefrontHandler_Category_OK(t *testing.T) {
	...
	h := storefront.NewStorefrontHandler(engine, repo, categoryRepo, pdp, plp, searchEngine)
...
func TestStorefrontHandler_Home_CategoryRepoError_Degrades(t *testing.T) {
	...
	h := storefront.NewStorefrontHandler(engine, repo, categoryRepo, pdp, plp, newStorefrontSearchMock())
...
func TestStorefrontHandler_SearchSuggestFragment_OK(t *testing.T) {
	...
	h := storefront.NewStorefrontHandler(engine, repo, newStorefrontCategoryMock(), pdp, plp, searchEngine)
...
func TestStorefrontHandler_SearchSuggestFragment_NoSearchEngine(t *testing.T) {
	...
	pdp := composition.NewPipeline[composition.ProductContext]()
	plp := composition.NewPipeline[composition.ListingContext]()
	h := storefront.NewStorefrontHandler(engine, repo, newStorefrontCategoryMock(), pdp, plp, nil)
