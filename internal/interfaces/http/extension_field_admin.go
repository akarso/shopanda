...
func (h *ExtensionFieldAdminHandler) ListFields() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		JSON(w, http.StatusOK, map[string]interface{}{"fields": resp})
	}
}
...
func (h *ExtensionFieldAdminHandler) GetField() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		JSON(w, http.StatusOK, map[string]interface{}{"field": toExtensionFieldResponse(field)})
	}
}
...
func (h *ExtensionFieldAdminHandler) CreateField() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		JSON(w, http.StatusCreated, map[string]interface{}{"field": toExtensionFieldResponse(field)})
	}
}
