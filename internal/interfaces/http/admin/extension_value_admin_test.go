...
func (m *mockExtensionValueRepo) ListByTargets(_ context.Context, targetType domainext.TargetType, targetIDs []string) ([]domainext.Value, error) {
	out := make([]domainext.Value, 0)
...
func newExtensionValueAdminRouter(h *admin.ExtensionValueAdminHandler) *http.ServeMux {
...
func setupExtensionValueAdmin(t *testing.T) (*admin.ExtensionValueAdminHandler, *http.ServeMux) {
	t.Helper()
	...
	h := admin.NewExtensionValueAdminHandler(svc)
