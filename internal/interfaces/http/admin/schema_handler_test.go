...
func schemaSetup() (*domainadmin.Registry, *http.ServeMux) {
	reg := domainadmin.NewRegistry()
	reg.RegisterForm("product.form", domainadmin.Form{
		Fields: []domainadmin.Field{
			{Name: "name", Type: "text", Label: "Product Name", Required: true},
			{Name: "status", Type: "select", Label: "Status", Options: []domainadmin.Option{
				{Label: "Draft", Value: "draft"},
				{Label: "Active", Value: "active"},
			}, Default: "draft"},
		},
	})
	reg.RegisterGrid("product.grid", domainadmin.Grid{
		Columns: []domainadmin.Column{
			{Name: "id", Label: "ID"},
...
func schemaPermSetup() (*domainadmin.Registry, *http.ServeMux) {
	reg := domainadmin.NewRegistry()
	reg.RegisterForm("product.form", domainadmin.Form{
		Fields: []domainadmin.Field{
			{Name: "name", Type: "text", Label: "Product Name", Required: true},
...
func schemaPermNoAuthSetup() *http.ServeMux {
	...
	reg.RegisterGrid("product.grid", domainadmin.Grid{
		Columns: []domainadmin.Column{{Name: "id", Label: "ID"}},
	})
	_ = reg.SetFormPermission("product.form", rbac.ProductsWrite)
	_ = reg.SetGridPermission("product.grid", rbac.ProductsRead)
