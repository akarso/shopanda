...
func TestCustomerAdminHandler_List_AuditIncludesScopeContext(t *testing.T) {
	...
	sink := &auditSink{}
	h := admin.NewCustomerAdminHandlerWithAuditor(repo, adminapp.NewAuditor(sink))
...
func TestCustomerAdminHandler_List_CustomerForbidden(t *testing.T) {
	repo := &mockAdminCustomerRepo{}
	h := admin.NewCustomerAdminHandlerWithAuditor(repo, adminapp.NewAuditor(logger.NewWithWriter(nilWriter{}, "info")))
...
func TestCustomerAdminHandler_Delete_AuditIncludesScopeContext(t *testing.T) {
	...
	sink := &auditSink{}
	h := admin.NewCustomerAdminHandlerWithAuditorAndDeleter(repo, repo, adminapp.NewAuditor(sink))
...
func TestCustomerAdminHandler_Delete_MisconfiguredAuditsFailure(t *testing.T) {
	repo := &mockAdminCustomerRepo{}
	sink := &auditSink{}
	h := admin.NewCustomerAdminHandlerWithAuditorAndDeleter(repo, nil, adminapp.NewAuditor(sink))
...
func TestCustomerAdminHandler_Delete_CustomerForbidden(t *testing.T) {
	repo := &mockAdminCustomerRepo{}
	h := admin.NewCustomerAdminHandlerWithAuditorAndDeleter(repo, repo, adminapp.NewAuditor(logger.NewWithWriter(nilWriter{}, "info")))
