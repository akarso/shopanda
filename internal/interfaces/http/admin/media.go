...
func (h *MediaHandler) List() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]interface{}{"assets": out})
	}
}
...
func (h *MediaHandler) Upload() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusCreated, toAssetResponse(mediaApp.AssetView{
			Asset:      result.Asset,
			URL:        result.URL,
...
func (h *MediaHandler) Delete() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]interface{}{"deleted": true, "asset_id": assetID})
	}
}
