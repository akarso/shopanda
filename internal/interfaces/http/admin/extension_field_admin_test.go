...
func newExtensionFieldAdminRouter(h *admin.ExtensionFieldAdminHandler) *http.ServeMux {
...
func TestExtensionFieldAdminHandler_CreateAndGet(t *testing.T) {
	...
	h := admin.NewExtensionFieldAdminHandler(extensionapp.NewFieldService(reg, repo))
...
func TestExtensionFieldAdminHandler_ListFiltersByTargetType(t *testing.T) {
	...
	h := admin.NewExtensionFieldAdminHandler(svc)
	router := newExtensionFieldAdminRouter(h)
