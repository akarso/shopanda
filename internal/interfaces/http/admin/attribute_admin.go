...
func (h *AttributeAdminHandler) ListAttributes() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]interface{}{"attributes": resp})
	}
}
...
func (h *AttributeAdminHandler) GetAttribute() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]interface{}{"attribute": toAttributeResponse(attr, groups)})
	}
}
...
func (h *AttributeAdminHandler) CreateAttribute() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusCreated, map[string]interface{}{"attribute": toAttributeResponse(attr, groups)})
	}
}
...
func (h *AttributeAdminHandler) ListGroups() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]interface{}{"groups": resp})
	}
}
...
func (h *AttributeAdminHandler) GetGroup() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusOK, map[string]interface{}{"group": toGroupResponse(group)})
	}
}
...
func (h *AttributeAdminHandler) CreateGroup() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httpshared.JSON(w, http.StatusCreated, map[string]interface{}{"group": toGroupResponse(group)})
	}
}
