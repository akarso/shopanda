...
func newCategoryAuditRouter(h *admin.CategoryAdminHandler) *http.ServeMux {
...
func TestCategoryAdmin_Create_AuditsScope(t *testing.T) {
	...
	sink := &auditSink{}
	h := admin.NewCategoryAdminHandlerWithAuditor(repo, categoryBus(), adminapp.NewAuditor(sink))
...
func TestCategoryAssignment_Assign_AuditsScope(t *testing.T) {
	...
	sink := &auditSink{}
	h := admin.NewCategoryProductAssignmentAdminHandlerWithAuditor(categories, products, assignments, adminapp.NewAuditor(sink))
...
func TestStoreAdmin_Create_AuditsScope(t *testing.T) {
	...
	sink := &auditSink{}
	h := admin.NewStoreAdminHandlerWithAuditor(repo, storeAdminBus(), adminapp.NewAuditor(sink))
