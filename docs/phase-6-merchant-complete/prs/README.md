...
| --- | --- | --- | --- | --- |
| PR-600 | A | [oss] | planned | [Navigation builder admin UI](PR-600.md) |
...
| PR-620 | C | [oss] | planned | [Webhook endpoints admin UI](PR-620.md) |
...
**Suggested next PRs:** PR-600 (navigation UI) → PR-601 → PR-602, then PR-620 (webhooks UI).
