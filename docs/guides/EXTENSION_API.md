...
| --- | --- |
| Hook point names | `extapi.HookCartAddItemBefore`, `HookCartAddItemAfter`, `HookCartUpdateItemBefore`, `HookCartRemoveItemAfter`, `HookCartRecalculateBefore`, `extapi.HookPoints()` |
