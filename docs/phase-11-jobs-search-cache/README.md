...
**In progress.** PR-1027 (reservation expiry gap), PR-1028 (job introspection), and PR-1029 (jobs admin API) are done. The rest of Track A (PR-1030–1032) and Tracks B–D (PR-1033–1047) are still planned.
