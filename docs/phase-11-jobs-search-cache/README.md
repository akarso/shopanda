...
**In progress.** PR-1027 (reservation expiry gap), PR-1028 (job introspection), PR-1029 (jobs admin API), and PR-1030 (scheduler admin) are done. The rest of Track A (PR-1031–1032) and Tracks B–D (PR-1033–1047) are still planned.
